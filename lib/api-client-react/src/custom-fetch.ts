...
function resolvedUrl(input: RequestInfo | URL): string {
...
export async function customFetch<T = unknown>(
    ...
    if (
        typeof init.body === "string" && !headers.has("content-type") && looksLikeJson(init.body)
    ) {
    ...
    const requestInfo = { method, url: resolvedUrl(input) };
